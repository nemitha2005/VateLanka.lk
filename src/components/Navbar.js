      ...
      <div className="container mx-auto px-6 lg:px-10 py-4 flex justify-between items-center">
        ...
        <ul
          className={`
            ...
            bg-green-500 lg:bg-transparent
        ...
        >
          {navLinks.map((link) => (
            <li key={link.href} className="block lg:inline-block py-3 lg:py-0 text-center">
              <a
                href={link.href}
                className={`
                  text-white block lg:inline
                  hover:underline hover:underline-offset-4 hover:decoration-green-200
                  px-4 lg:px-0
